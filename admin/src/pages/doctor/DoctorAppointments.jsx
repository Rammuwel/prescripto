      ...
      <div className='bg-white border rounded text-sm max-h-[80vh] min-h-[50vh] overflow-scroll'>
        ...
        </div>
        {
          appointments.map((item, index) => (
            <div key={index} className='flex flex-wrap justify-between max-sm:gap-5 max-sm:text-base sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] py-3 px-6 items-center text-gray-500 border-b hover:bg-gray-50'>
